...
import gr.hubit.library.R; // Explicit import needed for internal Google builds.
...
public abstract class CameraActivity extends Fragment
  ...
  public void requestRender() {
    final OverlayView overlay = (OverlayView) thisView.findViewById(R.id.debug_overlay);
    if (overlay != null) {
  ...
  public boolean myOnKeyDown(final int keyCode, final KeyEvent event) {
